...
const deviceController = {
  addDevice: async (req, res) => {
    try {
      const { serialNumber, type, locationName, image, status, locationId } = req.body;
      //check parent ID was existing
      const ExistingDevice = await Device.findOne({ serialNumber: serialNumber });
      ...
      if (res) {
        ...
        await Location.updateOne({ _id: locationId }, { $push: { devices: type } })
      }
